...
export function Button({message, onClick}: {message: string, onClick: any}) {
  return (
    <StyledWrapper>
...
export function ButtonBlue({message, onClick}: {message: string, onClick: any}) {
  return (
    <StyledWrapperBlue>
      <button className="uiverse" onClick={onClick}>
        <div className="wrapper">
...
const StyledWrapperBlue = styled.div`
  .uiverse {
    --duration: 7s;
    --easing: linear;
    --c-color-1: #ffd58c;
